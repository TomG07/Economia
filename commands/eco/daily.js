...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        if (Date.now() < userdb.eco.timers.dailyCooldown) return message.reply({ content: `Você se encontra em modo de recarga, tente novamente ${~~(userdb.eco.timers.dailyCooldown / 1000 )}.` });
